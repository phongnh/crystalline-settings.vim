function! crystalline#theme#solarized8#SetTheme() abort
  if &background ==# 'dark'
    call crystalline#GenerateTheme({
          \ 'A':                [[230, 245], ['#002b36', '#268bd2'], ''],
