...
if exists('g:loaded_vim_crystalline_settings')
    finish
endif
...
augroup CrystallineSettings
    ...
    autocmd User FugitiveChanged crystalline_settings#fugitive#FugitiveChanged()
    ...
    if v:vim_did_enter
        ...
        autocmd VimEnter * ++once crystalline_settings#Init()
    endif
augroup END
